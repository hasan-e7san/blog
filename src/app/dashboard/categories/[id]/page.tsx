  ...
  return (
    <div style={{ maxWidth: '600px' }}>
      <div style={{ marginBottom: '2.5rem' }}>
        ...
        <h1 style={{ fontSize: '1.75rem' }}>Edit Category</h1>
        <p className="text-muted" style={{ fontSize: '0.9rem' }}>ID: {category.id}</p>
      </div>

      <form action={updateCategory.bind(null, category.id)} className="card" style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', padding: '1.5rem', background: 'rgba(255,255,255,0.02)', borderRadius: '8px', border: '1px solid var(--card-border)' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <input name="isActive" type="checkbox" defaultChecked={category.isActive} style={{ width: '18px', height: '18px' }} />
          </div>
        </div>
